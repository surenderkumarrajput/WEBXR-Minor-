...
let interactableProperties = {
  cube: (intersectRef) => {
    ...
    gsap.to(intersectRef.object.position, 2, {
      x: intersectRef.object.position.x,
      y: intersectRef.object.position.y,
      z: -2,
      onComplete: () => {
        scene.remove(intersectRef.object);
      }
    })
  },
  Mesh_0: (intersectRef) => {
...
//Custom function created for traversing child of an UI(Block) object.
